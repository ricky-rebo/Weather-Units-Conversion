...
// km -> nautical miles
export const km2nmiles = (val: number, decimals?: number) => round((val / 1.85200), decimals || DEF_PRECISION);
...
// nautical miles -> km
export const nmiles2km = (val: number, decimals?: number) => round((val * 1.85200), decimals || DEF_PRECISION);
